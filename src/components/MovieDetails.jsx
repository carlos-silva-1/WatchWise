    ...
    return(
        <>
            <div className="ml-5 mt-5 pt-5">
                <div className="row details-title ml-3">
                    <div>
                        {
                ...
                <div className="row mt-3 ml-1 mr-5">
...

                {
                    ...
                    "release_date" in movie?
                    <>
                        <h2 className="mt-4 ml-4 primary-color">Trailer</h2>
                        <div className="mt-4 mr-3 ml-1 trailer-wrapper">
